...
def inferEmbeddings(args, dataset, split):
	...
	model = resnet50(pretrained=0, num_classes=dataset.getNumClasses(), ckpt_path=args.model_path,
...
if __name__ == '__main__':
	...
	# Required arguments
	#parser.add_argument('--model_path', nargs='?', type=str, default="/home/will/Desktop/Work/output_result/fold_0/best_model_state.pkl", ##,required=True,
	parser.add_argument('--model_path', nargs='?', type=str, default="/home/will/Downloads/ATI-Pilot-Project-masterfriday/ATI-Pilot-Project-master/MetricLearningIdentification-master/weights/TTL/50-50_fold-0.pkl",
						help='Path to the saved model to load weights from')
	parser.add_argument('--folds_file', type=str, default="/home/will/work/1-RA/src/Datasets/data/OpenCows2020/splits/10-90.json", #required=True,
