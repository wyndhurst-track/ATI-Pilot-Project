...
import Detector.RotatedRetinaNet.models.keras_resnet as keras_resnet
import Detector.RotatedRetinaNet.models.keras_resnet.models
...
def resnet_retinanet(num_classes, backbone='resnet50', inputs=None, modifier=None, **kwargs):
    ...
    if backbone == 'resnet50':
        # resnet = keras.applications.ResNet50(inputs, include_top=False, freeze_bn=True)
