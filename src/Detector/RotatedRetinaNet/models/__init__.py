...
def load_model(filepath, backbone_name='resnet50'):
    ...
    Returns   A keras.models.Model object.
...
def convert_model(model, nms=True, nms_threshold=0.5, class_specific_filter=True, anchor_params=None):
    ...
    return retinanet_bbox(model=model, nms=nms, nms_threshold=nms_threshold, class_specific_filter=class_specific_filter, anchor_params=anchor_params)
