...
#PBS -N RGB_cows
### Output files
#PBS -o RGB_console_output.stdout
#PBS -e RGB_error_output.stderr
...
# Running parameters
OUT_PATH="/work/ca0513/models/RGBDCows2020/ClosedSet/RGB/"

# Do the main stuff
python ResNet50.py --out_path=$OUT_PATH --img_type="RGB"
