...
#PBS -N RGBD_cows
### Output files
#PBS -o RGBD_console_output.stdout
#PBS -e RGBD_error_output.stderr
...
# Running parameters
OUT_PATH="/work/ca0513/models/RGBDCows2020/ClosedSet/RGBD/"

# Do the main stuff
python ResNet50.py --out_path=$OUT_PATH --img_type="RGBD"
