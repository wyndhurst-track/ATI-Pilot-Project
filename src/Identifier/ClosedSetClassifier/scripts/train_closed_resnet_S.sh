#!/bin/sh -login
### Job name
#PBS -N SCows_closed_ResNet
### Output files
#PBS -o S_console_output.stdout
#PBS -e S_error_output.stderr
...
# Running parameters
OUT_PATH="/work/ca0513/models/RGBDCows2020/ClosedSet/S/"
DEPTH_TYPE="binarised"

# Do the main stuff
python ResNet50.py --out_path=$OUT_PATH --img_type="D" --depth_type=$DEPTH_TYPE
