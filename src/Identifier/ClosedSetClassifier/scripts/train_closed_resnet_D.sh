...
#PBS -N D_cows
### Output files
#PBS -o D_console_output.stdout
#PBS -e D_error_output.stderr
...
# Running parameters
OUT_PATH="/work/ca0513/models/RGBDCows2020/ClosedSet/D/"

# Do the main stuff
python ResNet50.py --out_path=$OUT_PATH --img_type="D"
