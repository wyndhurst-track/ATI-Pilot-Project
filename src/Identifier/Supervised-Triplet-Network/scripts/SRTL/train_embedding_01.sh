...
#PBS -N SRTL_01
### Output files
#PBS -o console_output_01.stdout
#PBS -e error_output_01.stderr
### Configuration
...
UNKNOWN_RATIO=0.1
N=10
OUT_PATH="/work/ca0513/results/CEiA/SRTL/01"

# Change directory
cd /home/ca0513/ATI-Pilot-Project/src/Identifier/Supervised-Triplet-Network/

# Do the main stuff
python3 train.py --instances_to_eval="all" --unknown_ratio=$UNKNOWN_RATIO --out_path=$OUT_PATH --num_repeats=$N --softmax_enabled=True --reciprocal_loss_enabled=True
