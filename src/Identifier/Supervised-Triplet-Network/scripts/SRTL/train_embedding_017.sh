...
#PBS -N SRTL_017
### Output files
#PBS -o console_output_017.stdout
#PBS -e error_output_017.stderr
### Configuration
...
UNKNOWN_RATIO=0.17
N=10
OUT_PATH="/work/ca0513/results/CEiA/SRTL/017"

# Change directory
cd /home/ca0513/ATI-Pilot-Project/src/Identifier/Supervised-Triplet-Network/

# Do the main stuff
python3 train.py --unknown_ratio=$UNKNOWN_RATIO --out_path=$OUT_PATH --num_repeats=$N --softmax_enabled=True --reciprocal_loss_enabled=True
