...
#PBS -N RGBD_latent_9
### Output files
#PBS -o RGBD_console_output_9.stdout
#PBS -e RGBD_error_output_9.stderr
...
# Do the main stuff
python train.py --out_path=$OUT_PATH --img_type="RGBD" --start_fold=9 --end_fold=9 --exclude_difficult=1
