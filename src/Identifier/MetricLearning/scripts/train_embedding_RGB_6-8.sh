#!/bin/sh -login
### Job name
#PBS -N RGB_latent_6-8
### Output files
#PBS -o RGB_console_output_6-8.stdout
#PBS -e RGB_error_output_6-8.stderr
...
# Do the main stuff
python train.py --out_path=$OUT_PATH --img_type="RGB" --start_fold=6 --end_fold=8 #--exclude_difficult=1
