#!/bin/sh -login
### Job name
#PBS -N RGBD_latent_0-2
### Output files
#PBS -o RGBD_console_output_0-2.stdout
#PBS -e RGBD_error_output_0-2.stderr
...
# Running parameters
OUT_PATH="/work/ca0513/models/RGBDCows2020/LatentSpace/RGBD-no-difficult"

# Do the main stuff
python train.py --out_path=$OUT_PATH --img_type="RGBD" --start_fold=0 --end_fold=2 --exclude_difficult=1
