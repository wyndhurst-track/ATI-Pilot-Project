...
#PBS -N D_latent_6-8
### Output files
#PBS -o D_console_output_6-8.stdout
#PBS -e D_error_output_6-8.stderr
...
# Do the main stuff
python train.py --out_path=$OUT_PATH --img_type="D" --start_fold=6 --end_fold=8 --exclude_difficult=1
