#!/bin/sh -login
### Job name
#PBS -N RGBD_latent_3-5
### Output files
#PBS -o RGBD_console_output_3-5.stdout
#PBS -e RGBD_error_output_3-5.stderr
...
# Do the main stuff
python train.py --out_path=$OUT_PATH --img_type="RGBD" --start_fold=3 --end_fold=5 --exclude_difficult=1
