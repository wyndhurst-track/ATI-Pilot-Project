...
#PBS -N D_latent_0-2
### Output files
#PBS -o D_console_output_0-2.stdout
#PBS -e D_error_output_0-2.stderr
...
# Do the main stuff
python train.py --out_path=$OUT_PATH --img_type="D" --start_fold=0 --end_fold=2 --exclude_difficult=1
