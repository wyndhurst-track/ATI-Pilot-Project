...
if __name__ == '__main__':
	...
	parser.add_argument('--out_path', type=str, default="/home/will/Desktop/io",# required=True,
	...
	# Training settings
	parser.add_argument('--num_epochs', nargs='?', type=int, default=3, #100
						help='# of the epochs to train for')
	parser.add_argument('--eval_freq', nargs='?', type=int, default=1, #2
